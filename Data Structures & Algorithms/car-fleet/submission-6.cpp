// This stores the time instead of position in the stack. This makes the code compact as you don't need to calculate time of the previous one by looking up the value in the hashmap
class Solution {
public:
